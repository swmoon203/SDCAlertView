...
open class AlertController: UIViewController {
    ...
    */
    ...
    fileprivate func commonInit() {
        ...
        if self.preferredStyle == .actionSheet {
            let nibName = NSStringFromClass(ActionSheetView).components(separatedBy: ".").last!
    ...
    */
    ...
    @objc
    fileprivate func keyboardChange(_ notification: Notification) {
    ...
    fileprivate func addTextFieldsIfNecessary() {
    ...
    fileprivate func addChromeTapHandlerIfNecessary() {
    ...
    @objc
    fileprivate func chromeTapped(_ sender: UITapGestureRecognizer) {
